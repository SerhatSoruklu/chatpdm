...
| `concept:authority` with one leading space | `conceptauthority` | `no_exact_match` | raw query does not start with exact `concept:` prefix because of leading whitespace |
