...
const outputPaths = Object.freeze({
  previewJson: path.join(outputRoot, 'batch_003_writeback_preview_NOT_APPLIED.json'),
  diffMarkdown: path.join(outputRoot, 'batch_003_writeback_diff_preview.md'),
  validationReportJson: path.join(outputRoot, 'batch_003_writeback_validation_report.json'),
});
...
function buildValidationReport(candidates) {
  ...
  return {
    ...
    scope: 'batch 003 writeback preview only',
    status: 'NOT_APPLIED',
    boundaryDiscipline: {
