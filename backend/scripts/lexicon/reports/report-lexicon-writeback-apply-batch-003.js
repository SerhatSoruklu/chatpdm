...
const inputPaths = Object.freeze({
  preview: path.join(previewRoot, 'batch_003_writeback_preview_NOT_APPLIED.json'),
  validationReport: path.join(previewRoot, 'batch_003_writeback_validation_report.json'),
...
const outputPaths = Object.freeze({
  reportMarkdown: path.join(appliedRoot, 'batch_003_applied_writeback_report.md'),
  appliedDiffJson: path.join(appliedRoot, 'batch_003_applied_diff.json'),
});
...
function buildReportMarkdown(appliedDiff) {
  ...
  return [
    '# Batch 003 Applied Writeback Report',
    '',
